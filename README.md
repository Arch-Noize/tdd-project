...
# 📋 Practicing TDD with RSpec <a name="about-project"></a>

We've made a small project following Test-Driven Development practices in Ruby with Rspec
...
```sh
  git clone https://github.com/Arch-Noize/tdd-project.git
  cd tdd-projec
```
...
To run tests, simply:
- `cd` into the folder where the repository is stored
- and run `rspec`
...
- Adding tests to several classes
- Adding the classes themselves
...
Feel free to check the [Isues Pages](https://github.com/Arch-Noize/tdd-project/issues)
